...
export const formatPrice = (priceInCents: number, showDecimals: boolean) => {
  // Backend now sends amounts in cents, convert to dollars for display
  const dollars = centsToDollars(priceInCents).toNumber();
